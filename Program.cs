...
DataSourceInMemoryStorage CreateDataSourceStorage() {
    ...
    DashboardJsonDataSource jsonDataSourceCustomers = new DashboardJsonDataSource("Customers");
    jsonDataSourceCustomers.ConnectionName = "jsonCustomers";
    jsonDataSourceCustomers.RootElement = "Customers";
    dataSourceStorage.RegisterDataSource("jsonDataSourceCustomers", jsonDataSourceCustomers.SaveToXml());
...
app.Map("/", () => "Server running at http://localhost:5000");
